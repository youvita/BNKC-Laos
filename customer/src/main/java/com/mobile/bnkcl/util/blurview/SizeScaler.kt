...
internal class SizeScaler(private val scaleFactor: Float) {
    fun scale(width: Int, height: Int): Size {
        ...
        val scaledHeight =
            ceil((height / roundingScaleFactor).toDouble()).toInt()
    ...
    internal class Size(val width: Int, val height: Int, val scaleFactor: Float) {
