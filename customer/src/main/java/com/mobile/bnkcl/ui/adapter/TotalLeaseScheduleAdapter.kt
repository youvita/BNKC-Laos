...
class TotalLeaseScheduleAdapter : BaseAdapter<ItemTotalLeaseScheduleLayoutBinding, TotalLeaseScheduleResponse, TotalLeaseScheduleAdapter.ViewHolder>() {
    ...
    override fun setBindData(holder: ViewHolder, data: TotalLeaseScheduleResponse, position: Int) {
        binding.item = data
