 ...
 *
 */
class MainViewPagerApapter(fm: FragmentManager?, private val mContext: Context) :
    ...
    fun getTabView(position: Int): View {
        val view: View = LayoutInflater.from(mContext).inflate(R.layout.tab_item_layout, null)
