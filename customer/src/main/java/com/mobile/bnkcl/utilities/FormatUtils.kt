...
//        String language = PreferenceDelegator.getInstance(context).get(Constant.Language.LANGUAGE);
        val language = "en"
     ...
     */
    //    public static SpannableString getSeparateFontByLang(Context mContext, int indexStart, int indexEnd, String text, boolean isClicked){
    //        SpannableString ss = new SpannableString(text);
    //        if (isClicked){
    //            ss.setSpan(new CustomTypefaceSpan(Utils.getTypeFace(mContext, 2)), indexStart, indexEnd, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    //            ss.setSpan(new ForegroundColorSpan(mContext.getResources().getColor(R.color.color_d7191f)) , indexStart, indexEnd, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    //        }else{
    //            if (LocaleHelper.getLanguage(mContext).equals("en")){
    //                ss.setSpan(new CustomTypefaceSpan(Utils.getTypeFace(mContext, "en", 2)), indexStart, indexEnd, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    //            }
    //            ss.setSpan(new ForegroundColorSpan(mContext.getResources().getColor(R.color.color_cfd8dc)) , indexStart, indexEnd, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    //
    //        }
    //
    //        return ss;
